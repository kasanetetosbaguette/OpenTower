...
ds_map_set(global.achievements, "entrance1", "ACH_ENTRANCE_1");
ds_map_set(global.achievements, "entrance2", "ACH_ENTRANCE_2");
ds_map_set(global.achievements, "entrance3", "ACH_ENTRANCE_3");
ds_map_set(global.achievements, "medieval1", "ACH_MEDIEVAL_1");
ds_map_set(global.achievements, "medieval2", "ACH_MEDIEVAL_2");
ds_map_set(global.achievements, "medieval3", "ACH_MEDIEVAL_3");
ds_map_set(global.achievements, "ruin1", "ACH_RUIN_1");
ds_map_set(global.achievements, "ruin2", "ACH_RUIN_2");
ds_map_set(global.achievements, "ruin3", "ACH_RUIN_3");
ds_map_set(global.achievements, "dungeon1", "ACH_DUNGEON_1");
ds_map_set(global.achievements, "dungeon2", "ACH_DUNGEON_2");
ds_map_set(global.achievements, "dungeon3", "ACH_DUNGEON_3");
ds_map_set(global.achievements, "badland1", "ACH_BADLAND_1");
ds_map_set(global.achievements, "badland2", "ACH_BADLAND_2");
ds_map_set(global.achievements, "badland3", "ACH_BADLAND_3");
ds_map_set(global.achievements, "graveyard1", "ACH_GRAVEYARD_1");
ds_map_set(global.achievements, "graveyard2", "ACH_GRAVEYARD_2");
ds_map_set(global.achievements, "graveyard3", "ACH_GRAVEYARD_3");
ds_map_set(global.achievements, "farm1", "ACH_FARM_1");
ds_map_set(global.achievements, "farm2", "ACH_FARM_2");
ds_map_set(global.achievements, "farm3", "ACH_FARM_3");
ds_map_set(global.achievements, "saloon1", "ACH_SALOON_1");
ds_map_set(global.achievements, "saloon2", "ACH_SALOON_2");
ds_map_set(global.achievements, "saloon3", "ACH_SALOON_3");
ds_map_set(global.achievements, "plage1", "ACH_BEACH_1");
ds_map_set(global.achievements, "plage2", "ACH_BEACH_2");
ds_map_set(global.achievements, "plage3", "ACH_BEACH_3");
ds_map_set(global.achievements, "forest1", "ACH_FOREST_1");
ds_map_set(global.achievements, "forest2", "ACH_FOREST_2");
ds_map_set(global.achievements, "forest3", "ACH_FOREST_3");
ds_map_set(global.achievements, "space1", "ACH_SPACE_1");
ds_map_set(global.achievements, "space2", "ACH_SPACE_2");
ds_map_set(global.achievements, "space3", "ACH_SPACE_3");
ds_map_set(global.achievements, "minigolf1", "ACH_GOLF_1");
ds_map_set(global.achievements, "minigolf2", "ACH_GOLF_2");
ds_map_set(global.achievements, "minigolf3", "ACH_GOLF_3");
ds_map_set(global.achievements, "street1", "ACH_STREET_1");
ds_map_set(global.achievements, "street2", "ACH_STREET_2");
ds_map_set(global.achievements, "street3", "ACH_STREET_3");
ds_map_set(global.achievements, "sewer1", "ACH_SEWER_1");
ds_map_set(global.achievements, "sewer2", "ACH_SEWER_2");
ds_map_set(global.achievements, "sewer3", "ACH_SEWER_3");
ds_map_set(global.achievements, "industrial1", "ACH_INDUSTRIAL_1");
ds_map_set(global.achievements, "industrial2", "ACH_INDUSTRIAL_2");
ds_map_set(global.achievements, "industrial3", "ACH_INDUSTRIAL_3");
ds_map_set(global.achievements, "freezer1", "ACH_FREEZER_1");
ds_map_set(global.achievements, "freezer2", "ACH_FREEZER_2");
ds_map_set(global.achievements, "freezer3", "ACH_FREEZER_3");
ds_map_set(global.achievements, "chateau1", "ACH_CHATEAU_1");
ds_map_set(global.achievements, "chateau2", "ACH_CHATEAU_2");
ds_map_set(global.achievements, "chateau3", "ACH_CHATEAU_3");
ds_map_set(global.achievements, "kidsparty1", "ACH_KIDSPARTY_1");
ds_map_set(global.achievements, "kidsparty2", "ACH_KIDSPARTY_2");
ds_map_set(global.achievements, "kidsparty3", "ACH_KIDSPARTY_3");
ds_map_set(global.achievements, "war1", "ACH_WAR_1");
ds_map_set(global.achievements, "war2", "ACH_WAR_2");
ds_map_set(global.achievements, "war3", "ACH_WAR_3");
ds_map_set(global.achievements, "pepperman", "ACH_BOSS_1");
ds_map_set(global.achievements, "vigilante", "ACH_BOSS_2");
ds_map_set(global.achievements, "noise", "ACH_BOSS_3");
ds_map_set(global.achievements, "fakepep", "ACH_BOSS_4");
ds_map_set(global.achievements, "pizzaface", "ACH_BOSS_5");
ds_map_set(global.achievements, "sranks1", "ACH_SRANK_1");
ds_map_set(global.achievements, "sranks2", "ACH_SRANK_2");
ds_map_set(global.achievements, "sranks3", "ACH_SRANK_3");
ds_map_set(global.achievements, "sranks4", "ACH_SRANK_4");
ds_map_set(global.achievements, "sranks5", "ACH_SRANK_5");
ds_map_set(global.achievements, "pranks1", "ACH_PRANK_1");
ds_map_set(global.achievements, "pranks2", "ACH_PRANK_2");
ds_map_set(global.achievements, "pranks3", "ACH_PRANK_3");
ds_map_set(global.achievements, "pranks4", "ACH_PRANK_4");
ds_map_set(global.achievements, "pranks5", "ACH_PRANK_5");

ds_map_set(global.achievements, "halloween1", "ACH_HALLOWEEN_1");
ds_map_set(global.achievements, "halloween2", "ACH_HALLOWEEN_2");
